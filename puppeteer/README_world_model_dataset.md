...
- [REINFORCE_continuous.py](./inference/policy/REINFORCE_continuous.py)
- [workflow_dataset_recorder.py](./inference/policy/workflow_dataset_recorder.py)
...
- 世界模型  
  [workflow_world_model.py](./inference/policy/workflow_world_model.py)
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 730 
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 493 
当前有两种模式：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 230 
它的输入包括：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 260 
输入证据主要有三类：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 415 
输入包括：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 277 
输入包括：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 479 
输入包括：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 433
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 536 
它会把以下表示拼接起来：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 557
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 575
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 594 
这里有两层状态更新：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 575
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 576 
具体做法是：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 594
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 596 
生成路径是：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 598
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 611 
每个头的作用如下：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 616 
输入是：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 456
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 600 
当前默认包括：
...
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 658
- [workflow_world_model.py](./inference/policy/workflow_world_model.py) line 719 
当前实现里：
